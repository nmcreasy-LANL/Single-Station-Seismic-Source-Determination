...
# -*- coding: utf-8 -*-
"""
PAR_FILE_Peru_091243.py - Parameter file for Peru (different window) 2015 event analysis

This file contains all configuration parameters for analyzing the Peru event.
To run analysis with this parameter file:
    python sparse_data_location_analysis.py --par_file par_files/PAR_FILE_Peru_091243.py
...
FILES = [
    'II.BFO.00.BHE.M.2015.180.091243.SAC',  # East component
    'II.BFO.00.BHZ.M.2015.180.091243.SAC',  # Vertical component
    'II.BFO.00.BHN.M.2015.180.091243.SAC'   # North component
]
...
EVENT_TIME = "2015-06-29T09:09:21"  # Set to None for blind analysis
...
SOURCE_DEPTH_KM = 38      # True source depth in kilometers
DISTANCE_DEG = 97.3       # True epicentral distance in degrees
...
TRUE_EVENT_LAT = -15.9902  # True event latitude (degrees)
TRUE_EVENT_LON = -74.1826  # True event longitude (degrees)
...
PERIOD_MIN = 120            # Minimum period (seconds)
PERIOD_MAX = 230            # Maximum period (seconds)
OVERLAP_PERCENT = 90        # Band overlap percentage (high overlap = more data)
